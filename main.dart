      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: TextField(
            ...
            decoration: const InputDecoration(hintText: 'Escribe el objeto a añadir'),
          ),
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                _addTodoItem(_textFieldController.text, _textFieldController2.text);
              },
            ),
            TextButton(
          ...
          itemBuilder: (context, index){
            return Card(
                child: Column(
                  ...
                  children: <Widget>[
                  ListTile(
                  onTap: () {_handleTodoChange(_todos[index]);},
                  title: Text(_todos[index].name, style: _getTextStyle(_todos[index].checked)),
